...
class MeshFactory : public mesh::MeshFactory {
 public:
  ...
  /**
   * @brief Construct a new builder that can be used to construct a new polytopicmesh
   *        mesh.
 ...
 private:
  ...
  polytopicmesh::Mesh::NodeCoordList nodes_;
  polytopicmesh::Mesh::EdgeList edges_;
  polytopicmesh::Mesh::CellList elements_;
